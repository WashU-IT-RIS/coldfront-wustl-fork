...
class AllocationDetailView(LoginRequiredMixin, UserPassesTestMixin, TemplateView):
    ...
    def _get_previous_value_for_change_request(self, change_request):
        ...
        history = changing_allocation_attribute.history.filter(
            history_date__lt=change_request.created
    ...
    def get_context_data(self, **kwargs):
        ...
        allocation_changes = AllocationAttributeChangeRequest.objects.filter(
            allocation_change_request__allocation=allocation_obj
        ).order_by("-pk")
        ...
        for change_request in allocation_changes:
            change_request.previous_value = self._get_previous_value_for_change_request(
                change_request
            )

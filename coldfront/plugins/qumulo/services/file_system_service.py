...
class FileSystemService:
    ...
    def get_file_system_stats(storage_resource: str) -> dict:
        ...
        total_size = _get_size_in_pt(file_system_stats.get("total_size_bytes"))
        free_size = _get_size_in_pt(file_system_stats.get("free_size_bytes"))
        snapshot_size = _get_size_in_pt(file_system_stats.get("snapshot_size_bytes"))
        return {
...
def _get_size_in_pt(size_in_bytes: int) -> float:
    ...
    return round(_bytes_to_petabytes(int(size_in_bytes)), 4)

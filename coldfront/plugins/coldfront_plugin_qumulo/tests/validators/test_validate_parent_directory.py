...
class TestValidateParentDirectory(TestCase):
    def setUp(self):
        ...
        self.mock_get_acl = MagicMock()
        self.mock_get_acl.return_value = mock_response
        self.mock_qumulo_api.return_value.rc.fs.get_acl_v2 = self.mock_get_acl
    ...
    def test_returns_invalid_for_child_with_bad_parent(self):
        self.mock_get_acl.side_effect = Exception()

...
class ACL_SpecBuilder:
    ...
    def build_specs(
        self, alloc_name: str, sub_alloc_names: List[str], access_mode: str
    ):
        ...
        with open(
            ...
            for sub_alloc_name in sub_alloc_names:
                self.sub_alloc_root_specs[sub_alloc_name] = (
                    sub_alloc_root_template.replace(
                        "<SUB_ALLOC>", sub_alloc_name
        ...
        with open(
            ...
            for sub_alloc_name in sub_alloc_names:
                self.sub_alloc_folder_specs[sub_alloc_name] = (
                    sub_alloc_folder_template.replace(
                        "<SUB_ALLOC>", sub_alloc_name
                    ).replace("<ALLOC>", alloc_name)
                )
        with open(
            ...
            for sub_alloc_name in sub_alloc_names:
                self.sub_alloc_file_specs[sub_alloc_name] = (
                    sub_alloc_file_template.replace(
                        "<SUB_ALLOC>", sub_alloc_name
                    ).replace("<ALLOC>", alloc_name)
                )
